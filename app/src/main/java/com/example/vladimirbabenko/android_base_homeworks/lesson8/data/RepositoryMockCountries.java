...
public class RepositoryMockCountries implements IRepositoryMock<Country> {
    ...
    public List<Country> fetchMocks(){
        List<Country> countries = new ArrayList<>();
         ...
         String[] countryNames = {"Киев", "Харьков", "Львов", "Ужгород", "Тернополь", "Коломия", "Хорватия", "Польша",
            "Америка", "Катя"};
         String[] countryCapitals = {"Киев-Center", "Харьков-Center", "Львов-Center", "Ужгород-Center", "Тернополь-Center", "Коломия-Center", "Хорватия-Center", "Польша-Center",
